...
class StraightSegmentFactory : public SegmentFactory
{
	...
	StraightSegmentFactory(StraightSegment * proto, SegmentGraphicFactory* factory)
	...
	SegmentInstance* instance(Coords const & pos, Segment::Direction dir)
	{
		...
		return new StraightSegmentInstance(
			mPrototype.get(), pos, o, mGraphicFactory->instance(pos, dir));
	}
