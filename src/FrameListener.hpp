...
protected:
	...
	std::list<OgreRails::MovingConsist*> mConsists;
...
using namespace Ogre;
	...
	virtual ~FrameListener()
	{
		...
		std::list<OgreRails::MovingConsist*>::iterator it = mConsists.begin();
		while(it != mConsists.end()) {
			delete *(it);
			it++;
		}
	}

	void addConsist(OgreRails::MovingConsist* mc){
			mConsists.push_back(mc);
	}
